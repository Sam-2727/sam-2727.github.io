...
## Contact
{: .no_toc .no-number}
- Professional: samchristian@fas.harvard.edu
- Personal: samchristianemail@gmail.com
- Github: [Sam-2727](https://github.com/sam-2727)

## Notes, etc.
{: .no_toc .no-number}

Occasionally, I write [physics notes](/blog) that I think others in my field will find useful. I hope to write more generally accessible write-ups at some point.